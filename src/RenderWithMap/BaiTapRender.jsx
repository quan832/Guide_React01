...
export default class BaiTapRender extends Component {
  dataFilm = [
    {
      maPhim: 1321,
      tenPhim: "Ted2",
  ...
  //   viet ham hien thi danh sach phim duoi dang div bootstrap
  renderPhim = () => {
    const arrJSX = this.dataFilm.map((film, index) => {
      return (
        <div key={index} className="col-4 ">
          <div className="card my-5 bg-dark text-white">
            <div style={{background:`url("${film.hinhAnh}")` ,backgroundPosition:`center`,backgroundSize:`cover`}}>
              <img 
              style={{opacity:0}}
                width="150"
                height="300"
            ...
            <div className="card-body text-white">
              ...
              <p style={{ height: 80 }} className="card-text ">
